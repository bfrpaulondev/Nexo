...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BKf88c85.mjs");
...
var manifest = {
	"175dc3c021eff0421da7c49d45e17b3f90c02a455a9954d390f4367e6a855f9d": {
		functionName: "askIris_createServerFn_handler",
		importer: () => import("./ai-tutor-DxpclNsk.mjs")
	},
	"d5b7a3d738aa851a7c4f6a649b87fc5a4550661ba903122a5242836037b9e82f": {
		functionName: "gradePrompt_createServerFn_handler",
		importer: () => import("./ai-tutor-DxpclNsk.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D_hJw81X.mjs").then((n) => n.t),
